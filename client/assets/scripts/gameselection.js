...
const questions = [
  ...
  {
    question:
      "On which date did Ukraine declare independence from the Soviet Union?",
    options: [
      "July 16, 1990",
      "December 25, 1991",
      "January 1, 1992",
  ...
  {
    question:
      "Who led the Indian independence movement using nonviolent protest?",
    options: [
      "Jawaharlal Nehru",
      "Mahatma Gandhi",
      "Subhas Chandra Bose",
...
function checkAnswer(userChoice) {
  ...
  if (userChoice === q.correct) {
    ...
    showPopup(
      "✅ Correct! Vault security bypassed! Click Next to try the next security layer",
      "correct",
    );
    myScore = myScore + 1;
    console.log(myScore);
